...
function change_comment_form_defaults($default) {
	...
	$fields =  array(
		...
		'email'  => '<p class="comment-form-email"><label for="email">' . __( 'Email', 'domainreference' ) . '</label> ' . ( $req ? '<span class="required">*</span>' : '' ) .
		            '<input id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>',
		'location'  => '<p class="comment-form-location"><label for="location">' . __( 'Location', 'domainreference' ) . '</label> '.
	...
	$default=array(
		...
		'comment_notes_before'=>'* required fields',
